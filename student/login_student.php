...
if (isset($_SESSION['uid']) && isset($_SESSION['user'])) {
    ...
    if ($_SESSION['user'] == 'student') {
        header("Location: " . BASE_URL . "/student/student_home.php");
        exit();
    }
...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($con, "select student_id from student_login where username='$email' && password_hash='$password'
");
    $ret = mysqli_fetch_array($query);
    if ($ret > 0) {
        $_SESSION['uid'] = $ret['student_id'];
        ...
        <div class="container">
            <div class="col-left">
                <div class="login-text">
                    ...
                    <a class="btn" href="./register_student.php">Sign Up</a>
                </div>
            </div>
            <div class="col-right">
