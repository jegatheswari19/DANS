...
if (isset($_POST['edit'])) {
    ...
    mysqli_query($con, "UPDATE student SET Name='$name', Sem='$sem', Department='$department', year='$year', email_id='$email', Programme='$programme' WHERE RegNo='$RegNo'");
                    ...
                    <tbody>
                        ...
                        <tr id="row-<?php echo $row['RegNo']; ?>">
                            <form method="POST" action="m_student.php">
                                ...
                                <td>
                                    <span class="view-mode"><?php echo htmlspecialchars($row['email_id']); ?></span>
                                    <input type="text" name="email" class="edit-mode"
                                        value="<?php echo htmlspecialchars($row['email_id']); ?>" style="display:none;">
                                </td>
                                <td>
                                    <span class="view-mode"><?php echo htmlspecialchars($row['Programme']); ?></span>
                                    <input type="text" name="programme" class="edit-mode"
                                        value="<?php echo htmlspecialchars($row['Programme']); ?>"
                                        style="display:none;">
                                </td>
                                <td>
